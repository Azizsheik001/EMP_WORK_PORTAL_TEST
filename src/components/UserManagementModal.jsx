                ...
                <li key={u.id} className="flex items-center justify-between gap-2 rounded-lg border border-inherit p-2">
                  <div className="min-w-0 flex-1">
                    ...
                    <span className="flex items-center gap-1 mt-0.5 flex-wrap">
                      ...
                      {u.team_lead_id && <span className="text-gray-500 dark:text-gray-400 text-xs">· TL: {getTeamLeadName(u.team_lead_id)}</span>}
                      {u.manager_id && <span className="text-gray-500 dark:text-gray-400 text-xs">· Mgr: {getManagerName(u.manager_id)}</span>}

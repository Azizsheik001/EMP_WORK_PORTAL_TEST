...
router.get('/summary', authenticate, async (req, res, next) => {
  try {
    ...
    // Combined coupon list: clock_in events + manual extras (including guests) for the month
    // Excludes users in food_coupon_exclusions
    // Daily breakdown
    ...
    // Per-person breakdown (employees + guests)
...
router.get('/', authenticate, async (req, res, next) => {
  try {
    ...
    // Query clock-in based coupons (excluding excluded users)
